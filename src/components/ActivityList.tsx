...
import { ActivityActions } from "../reducerrs/activityReducer";
...
export default function ActivityList({
  ...
  return (
    <>
      <h2 className="text-4xl font-bold text-center mb-4 text-slate-600">
        Comida y actividades
      </h2>

      {activities.length === 0 ? (
        <p className="text-center mt-2"> No hay actividades aún...</p>
      ) : (
